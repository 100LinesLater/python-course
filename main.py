...
def register():
    ...
    if form.validate_on_submit():
        ...
        if user:
            flash('Entered email already exists in our database.')
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user:
            ...
            flash('Entered email does not exist in our database.')
            return redirect(url_for('login'))
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        if current_user.is_authenticated:
            ...
            return redirect(url_for('login'))
    return render_template("post.html", post=requested_post, form=form, comments=requested_post.comments, logged_in=current_user.is_authenticated)
